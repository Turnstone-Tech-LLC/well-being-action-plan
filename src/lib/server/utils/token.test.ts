...
describe('token utility', () => {
	...
	describe('isValidTokenFormat', () => {
		...
		it('validates tokens generated by createSecureToken with valid length', () => {
			// Test with lengths within valid range (6-12)
			expect(isValidTokenFormat(createSecureToken(6))).toBe(true);
			expect(isValidTokenFormat(createSecureToken(8))).toBe(true);
			expect(isValidTokenFormat(createSecureToken(10))).toBe(true);
			expect(isValidTokenFormat(createSecureToken(12))).toBe(true);
		});
